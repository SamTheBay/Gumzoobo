...
namespace BubbleGame
{
    public class GameSprite
    {
        ...
        public virtual void Update(GameTime gameTime)
        {
            ...
            if (position.X < 208 + 24 - reduceSides/2 && isPawn == false)
            {
                position.X = 208 + 24 - reduceSides/2;
            }
            else if (position.X + frameDimensions.X > 1072 - 24 + reduceSides/2 && isPawn == false)
            {
                position.X = 1072 - 24 - frameDimensions.X + reduceSides/2;
            }
        }
        ...
        {
            // TODO: pass in a rectangle instead of allocating one here
            return new Rectangle((int)position.X + centeredReduce / 2, (int)position.Y + centeredReduce / 2, frameDimensions.X - centeredReduce, frameDimensions.Y - centeredReduce);
        }
        ...
        public virtual bool PixelCollision(GameSprite otherSprite)
        {
            ...
            Rectangle theirRect = otherSprite.GetBoundingRectangle();
