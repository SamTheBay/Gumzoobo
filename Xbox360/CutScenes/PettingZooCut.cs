...
namespace BubbleGame
{
    class PettingZooCut : CutSceneScreen
    {
        public PettingZooCut()
        {
            ...
            pawns[3] = new Pawn("Tortoise", new Vector2(-380, 450));

            // setup events in the scene
            events = new CutSceneEvent[4];
            events[0] = new CutSceneEvent(pawns[0], 1, CutSceneAction.Move, new Vector2(1400, 450));
            events[1] = new CutSceneEvent(pawns[1], 1, CutSceneAction.Move, new Vector2(1400, 450));
            events[2] = new CutSceneEvent(pawns[2], 1, CutSceneAction.Move, new Vector2(1400, 450));
            events[3] = new CutSceneEvent(pawns[3], 1, CutSceneAction.Move, new Vector2(1400, 450));
