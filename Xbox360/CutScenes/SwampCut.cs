...
namespace BubbleGame
{
    class SwampCut : CutSceneScreen
    {
        public SwampCut()
        {
            ...
            pawns[4] = new Pawn("FireDrone", new Vector2(1320, 450));
            pawns[5] = new Pawn("FireBall", new Vector2(950, 450));
            ...
            events[6] = new CutSceneEvent(pawns[5], 7000, CutSceneAction.Move, new Vector2(-100, 450));
            events[7] = new CutSceneEvent(pawns[0], 7500, CutSceneAction.Move, new Vector2(-100, 450));
            events[8] = new CutSceneEvent(pawns[1], 7500, CutSceneAction.Move, new Vector2(-100, 450));
            events[9] = new CutSceneEvent(pawns[2], 7500, CutSceneAction.Move, new Vector2(-100, 450));
            events[10] = new CutSceneEvent(pawns[3], 7500, CutSceneAction.Move, new Vector2(-100, 450));
            events[11] = new CutSceneEvent(pawns[4], 10000, CutSceneAction.Move, new Vector2(1400, 450));
