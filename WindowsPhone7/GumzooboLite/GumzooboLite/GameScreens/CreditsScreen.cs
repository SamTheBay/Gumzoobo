    ...
    class CreditsScreen : GameScreen
    {
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            ...
            for (int i = 0; i < characters.Length; i++)
            {
                ...
                characters[i].SetClearPosition(new Vector2(400 - characters[i].TextureWidth / 2, 480 - elapsedTime / 20 + charaterPositions[i] * 40));
            }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            for (int i = 0; i < totalLines; i++)
            {
                Fonts.DrawCenteredText(spriteBatch, Fonts.DescriptionFont, creditsLines[i], new Vector2(400, 480 - elapsedTime/20 + i*40), Color.LightBlue, 1.5f); 
            }
        ...
        public bool ShouldResetMusic
        {
            set { shouldResetMusic = value; }
        }
    }
}