...
namespace BubbleGame
{
    class GiftShopCut : CutSceneScreen
    {
        public GiftShopCut()
        {
            ...
            pawns[4] = new Pawn("Drone", new Vector2(920, 250));

            // setup events in the scene
            events = new CutSceneEvent[6];
            events[0] = new CutSceneEvent(pawns[4], 1, CutSceneAction.Move, new Vector2(650, 250));
            ...
            events[5] = new CutSceneEvent(pawns[4], 6000, CutSceneAction.Move, new Vector2(1400, 250));
