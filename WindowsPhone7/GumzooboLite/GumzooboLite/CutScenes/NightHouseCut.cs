...
namespace BubbleGame
{
    class NightHouseCut : CutSceneScreen
    {
        public NightHouseCut()
        {
            ...
            events[0] = new CutSceneEvent(pawns[0], 1000, CutSceneAction.Move, new Vector2(1400, 250));
            events[1] = new CutSceneEvent(pawns[1], 1000, CutSceneAction.Move, new Vector2(1400, 250));
            events[2] = new CutSceneEvent(pawns[2], 1000, CutSceneAction.Move, new Vector2(1400, 250));
            events[3] = new CutSceneEvent(pawns[3], 1000, CutSceneAction.Move, new Vector2(1400, 250));
