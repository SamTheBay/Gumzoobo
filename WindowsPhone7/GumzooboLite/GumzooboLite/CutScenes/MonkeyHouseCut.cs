...
namespace BubbleGame
{
    class MonkeyHouseCut : CutSceneScreen
    {
        public MonkeyHouseCut()
        {
            ...
            pawns[1] = new Pawn("WarpBot", new Vector2(-100, 250));

            // setup events in the scene
            events = new CutSceneEvent[24];
            events[0] = new CutSceneEvent(pawns[1], 1, CutSceneAction.Move, new Vector2(1400, 250));
            events[1] = new CutSceneEvent(pawns[0], 1000, CutSceneAction.Move, new Vector2(1400, 250));
            ...
            events[11] = new CutSceneEvent(pawns[1], 6000, CutSceneAction.ChangeLocation, new Vector2(100, 250));
            events[12] = new CutSceneEvent(pawns[0], 6500, CutSceneAction.Move, new Vector2(100, 250));
            ...
            events[21] = new CutSceneEvent(pawns[1], 10000, CutSceneAction.ChangeLocation, new Vector2(900, 250));
            events[22] = new CutSceneEvent(pawns[0], 10500, CutSceneAction.Move, new Vector2(14000, 250));
            events[23] = new CutSceneEvent(pawns[1], 10500, CutSceneAction.Move, new Vector2(14000, 250));
        }
    }
}