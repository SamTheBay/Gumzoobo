...
{
    public class SuperBubbleWeapon : WeaponSprite
    {
        ...
        public SuperBubbleWeapon(PlayerSprite owner) :
            base(owner, 23000)
        {
            playerOwner = owner;
            AddAnimation(new Animation("Bubble", 1, 3, 100, false, SpriteEffects.None, Color.HotPink));
            chewCost = 25;
            centeredReduce = 74;
        }
        ...
        public static void LoadStatic()
        {
            ...
            iconLocation = new Rectangle(120, 0, 60, 40);
        }
