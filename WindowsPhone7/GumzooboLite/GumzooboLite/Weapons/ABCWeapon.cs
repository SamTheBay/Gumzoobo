...
{
    public class ABCWeapon : WeaponSprite
    {
        ...
        public ABCWeapon(PlayerSprite owner) :
            base(owner, 17000)
        {
            playerOwner = owner;
            AddAnimation(new Animation("Bubble", 1, 3, 100, false, SpriteEffects.None, Color.Brown));
            chewCost = 0;
            centeredReduce = 74;
        }
        ...
        public static void LoadStatic()
        {
            ...
            iconLocation = new Rectangle(60, 0, 60, 40);
        }
